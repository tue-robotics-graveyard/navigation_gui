...
os.chdir(roslib.packages.get_pkg_dir('navigation_gui'))
...
if __name__ == '__main__':
	try:
		...
		try:
			port 	   = rospy.get_param('/navigation_gui_webserver/port', default_port)
			indexNames = rospy.get_param('/navigation_gui_webserver/index_names', ['index.html'])
